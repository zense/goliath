...
<div class="wrap">
	...
	<div class="module">
		<div class="ideas">
			...
			<?php $ideas_posts = $wpdb->get_results("SELECT * FROM $wpdb->posts WHERE post_status = 'draft' AND post_type = 'post' AND post_author=$user_ID ORDER BY post_date DESC"); ?>
	...
	<div class="published module">
		<h2>Published</h2>
		<?php $published_posts = $wpdb->get_results("SELECT * FROM $wpdb->posts WHERE post_status = 'publish' AND post_type = 'post' AND post_author=$user_ID ORDER BY post_date DESC");?>
